...
expName = 'WMpsilocybin_v5'  # from the Builder filename that created this script
expVersion = ''
...
def setupData(expInfo, dataDir=None):
    ...
    thisExp = data.ExperimentHandler(
        ...
        originPath='/Users/cnj678/Documents/GitHub/WM_Psilocybin/WMpsilocybin_v5_lastrun.py',
...
def run(expInfo, thisExp, win, globalClock=None, thisSession=None):
    ...
    report_fix = visual.Rect(
        ...
        colorSpace='rgb', lineColor='black', fillColor='black',
        opacity=None, depth=-1.0, interpolate=True)
    reportCircle = visual.Polygon(
        win=win, name='reportCircle',
        edges=256, size=(0.45, 0.45),
        ori=0.0, pos=(0, 0), draggable=False, anchor='center',
        lineWidth=10.0,
        colorSpace='rgb', lineColor=(0.3255, 0.3255, 0.3255), fillColor=None,
        opacity=None, depth=-2.0, interpolate=True)
    ...
    for thisPractice_trial in practice_trials:
        ...
        # after all 5 reported, wait for click on fixation square
        waiting_for_advance = False
        
        # NEW (Change 1): edge-detect click state
        prev_left = False
        ...
        while continueRoutine:
            ...
            if just_clicked:
                ...
                # if we're done, ONLY allow click on fixation square to advance
                if waiting_for_advance:
                    ...
                    # Change 2: commit snapped position on ANY click (no reportCircle.contains gate)
                    sx, sy = cursorDot.pos
                    cx, cy = reportCircle.pos
                    ...
                    # don't end immediately; enter waiting state
                    if all(reported):
