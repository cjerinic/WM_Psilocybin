...
expName = 'WMpsilocybin_v4'  # from the Builder filename that created this script
expVersion = ''
...
def setupData(expInfo, dataDir=None):
    ...
    thisExp = data.ExperimentHandler(
        ...
        originPath='/Users/cnj678/Documents/GitHub/WM_Psilocybin/WMpsilocybin_v4_lastrun.py',
